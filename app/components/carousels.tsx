...
const Carousels = () => {
  const languages = [
    '/assets/languages/C++_logo.png',
    '/assets/languages/cSharp.png',
    '/assets/languages/java-logo-1.png',
    '/assets/languages/Python-logo.png',
    '/assets/languages/javascript.webp',
    '/assets/languages/Typescript_logo_2020.svg.png',
    '/assets/languages/Matlab_Logo.png',
  ];
  const langNames = [
    'C++',
    'C#',
  ...
  const technologies = [
    '/assets/technologies/unity.png',
    '/assets/technologies/arduino.png',
    '/assets/technologies/android.webp',
    '/assets/technologies/github.png',
    '/assets/technologies/html.png',
    '/assets/technologies/tailwind.webp',
    '/assets/technologies/angular.png',
    '/assets/technologies/react.webp',
    '/assets/technologies/nextjs.png',
    '/assets/technologies/firebase.png',
    '/assets/technologies/R.png',
  ...
  return (
    <section>
      ...
      <div className="w-full text-center mt-5 lg:mt-14 text-3xl lg:text-5xl text-green-700">
        ...
        >
          <CarouselContent>
            {Array.from({ length: languages.length }).map((_, index) => (
              <CarouselItem
                key={index}
                className="md:basis-1/2 lg:basis-1/3 xl:basis-1/5 w-full"
              >
                <div className="p-1">
                  <Card className="border-0 bg-neutral-900">
                    <CardContent className="flex items-center justify-center p-6 bg-neutral-900 rounded-xl relative h-[15rem]">
                      <Image
                        ...
                        width={918}
                        height={1032}
                        className="h-36 w-fit top-6 absolute"
                      />
            ...
            <Card className="border-0 bg-neutral-900">
              <CardContent className="flex items-center justify-center p-6 bg-neutral-900 rounded-xl relative h-[11.5rem]">
                <Image
                  ...
                  width={918}
                  height={1032}
                  className="h-20 w-fit top-6 absolute"
                />
